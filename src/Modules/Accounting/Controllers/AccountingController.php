...
final class AccountingController
{
 ...
 public function setup(Request$r):Response{return$this->page('modules/accounting/setup','إعدادات الترحيل',['mappings'=>$this->service->setup(),'accounts'=>$this->service->references()['accounts']]);}
