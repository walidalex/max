...
use App\Modules\ClientProgressStatements\Validators\ClientProgressStatementTableQueryValidator;
final class ClientProgressStatementDataTableController
{
    public function __construct(
        private readonly ClientProgressStatementService $service,
        private readonly ClientProgressStatementTableQueryValidator $validator,
    ) {}
    public function global(Request $r): Response
    {
        return Response::json(
            $this->service->dataTable($this->validator->validate($r->all())),
        );
    }
