...
- [x] Bootstrap and environment loading
- [x] Router, request, response, and views
- [x] MySQLi prepared statement support
- [x] Validation, session, and authentication foundations
