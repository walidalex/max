...
$expected=['subcontract_boq.approve','subcontract_boq.manage','subcontract_boq.view','subcontracts.change_status','subcontracts.create','subcontracts.edit','subcontracts.view','client_contracts.change_status','client_contracts.create','client_contracts.edit','client_contracts.view','clients.activate','clients.create','clients.edit','clients.view','company_profile.edit','company_profile.view','contract_boq.approve','contract_boq.manage','contract_boq.view','contract_variations.approve','contract_variations.cancel','contract_variations.create','contract_variations.edit','contract_variations.view','cost_structure.manage','cost_structure.view','permissions.view','projects.change_status','projects.create','projects.edit','projects.view','roles.assign_permissions','roles.create','roles.edit','roles.view','users.activate','users.assign_roles','users.create','users.edit','users.view','vendors.activate','vendors.create','vendors.edit','vendors.view'];
