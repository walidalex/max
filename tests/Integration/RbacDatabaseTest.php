...
$expected=['clients.activate','clients.create','clients.edit','clients.view','company_profile.edit','company_profile.view','cost_structure.manage','cost_structure.view','permissions.view','projects.change_status','projects.create','projects.edit','projects.view','roles.assign_permissions','roles.create','roles.edit','roles.view','users.activate','users.assign_roles','users.create','users.edit','users.view','vendors.activate','vendors.create','vendors.edit','vendors.view'];
